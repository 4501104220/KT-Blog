        ...
        <div class="row">
            ...
            <div class="col-md-4 log-icons text-right">
                <ul class="social_list1 mt-3">
                    ...
                    <li>
                        <a href="<?php getlinks("links", "instagram"); ?>" class="instagram2">
                            <i class="fab fa-instagram"></i>
                        </a>
                    </li>
                    <li>
                        <a href="<?php getlinks("links", "linkedin"); ?>" class="linkedin2">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form action="search.php" method="post" class="form-inline my-2 my-lg-0 header-search" name="form">
                    <input class="form-control mr-sm-2" type="search" placeholder="Search here..." required="yes"
