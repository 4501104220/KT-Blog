...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColCaption = array("Facebook", "Twitter", "Googleplus", "Pinterest", "Dribble", "Comments script", "Sharing script", "Javascript", "Instagram", "Linkedin");
	$x->ColFieldName = array('facebook', 'twitter', 'googleplus', 'pinterest', 'dribble', 'comments_script', 'sharing_script', 'javascript', 'instagram', 'linkedin');
